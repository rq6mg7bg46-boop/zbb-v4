...
class AutomationModule(private val mReactContext: ReactApplicationContext) : 
    ...
    // 🆕 08-27 删冷却: setNativeTimeout / clearNativeTimeout / nativeTimers / clearNativeTimeoutInternal 已删除
    //   - 原 v32.19 用于 Cooldown 60s 倒计时 (Handler.postDelayed)
    //   - 流程正常结束后直接 Idle, 60s 倒计时不需要了
    @ReactMethod
