...
async function step14UploadScreenshot(): Promise<boolean> {
  ...
  try {
    ...
    // 🆕 V32.36.65 老板 09-22 拍板: 点"确认"后, 上滑屏幕刷新当前界面
    //   老板铁子反证金标准: 千机列表通常有分页或延迟, 不上滑可能漏看新客户
    //   修法: swipe(540, 1800→540, 800) = 手指从下往上滑 (上滑手势, 内容向下滚 = 刷新)
    // 🆕 V32.36.68 老板 09-22 拍板: log 改"上滑" (老板 nova 11:44 反馈名义不对)
    logger.info('保利:步骤14-6', '上滑屏幕刷新当前界面 (V32.36.65 + V32.36.68 老板拍板)');
    await ZBBAutomation.swipe(540, 1800, 540, 800, 500);  // 手指从下往上滑 (上滑手势)
